namespace Microsoft.AspNetCore.Authentication
{
    ...
    public class AzureAdOptions
    {
        ...
        /// <summary>
        /// Identifier of the Analysis Services server API
        /// </summary>
        public string ServerAudience { get; set; }

        /// <summary>
        /// Identifier of the Analysis Services model API
        /// </summary>
        public string ModelAudience { get; set; }

        /// <summary>
        /// Base URL's of the server and the service
        /// </summary>
        public string ServerBaseAddress { get; set; }
        public string ModelBaseAddress { get; set; }
